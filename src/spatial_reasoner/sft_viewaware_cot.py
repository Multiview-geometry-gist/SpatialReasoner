...
"""
SFT Training with View-Aware CoT
Adds explicit viewpoint context to CoT reasoning for multi-view understanding.
"""
...
# ============================================================================
# CoT Coordinate Transformation (from sft_augmented.py)
# ============================================================================
...
def get_viewpoint_prefix(source_dataset: str) -> str:
    """Generate viewpoint-aware prefix based on dataset source."""
    if 'p10_ccw' in source_dataset:
        return "[Analyzing from a +10° counter-clockwise rotated viewpoint] "
    elif 'm10_cw' in source_dataset:
        return "[Analyzing from a -10° clockwise rotated viewpoint] "
    return ""
...
def main(script_args, training_args, model_args):
    ...
    viewpoint_aware_prefix = getattr(training_args, 'viewpoint_aware_prefix', True)
    ...
    def collate_fn(examples):
        ...
        for example in examples:
            if 'question' in example and example['question']:
                ...
                # Add viewpoint-aware prefix
                if viewpoint_aware_prefix:
                    prefix = get_viewpoint_prefix(source_dataset)
                    if prefix:
                        answer_cot = prefix + answer_cot
    ...
    kwargs = {
        ...
        "tags": ["SpatialReasoner", "ViewAware-CoT"],
    }
