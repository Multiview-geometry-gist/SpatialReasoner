...
# SpatialReasoner SFT Training Resume with 4 GPUs + ZeRO-2 (GPU 0,1,2,3)
# Resume from checkpoint-2000 using ZeRO-2 for compatibility
...
export WANDB_RUN_NAME=$(basename $model_name)-SFT-4GPU-ZeRO2-Resume-$(date +%Y-%m-%d-%H-%M-%S)

echo "========================================="
echo "Resuming SFT Training with 4 GPUs (ZeRO-2)"
echo "Model: $model_name"
echo "Dataset: $dataset_name"
echo "GPUs: 0, 1, 2, 3"
echo "DeepSpeed: ZeRO-2 (compatible with checkpoint)"
