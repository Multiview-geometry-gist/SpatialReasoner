...
\input{proposal/0.abstract}
\input{proposal/1.intro}
% \input{proposal/2.related_works}
\input{proposal/3.methods}
\input{proposal/4.experiments}
\input{proposal/5.conclusion}
{
    \small
